var PrintView = function (container, model) {
	...
	this.printMenu = function () {
			...
			for (var i = 0; i < dishes.length; i++) {
				...
				dishStr += '<img class="img" src="'+dish.ImageURL+'" alt="'+dish.Title+'"></img>';
				dishStr += '<div class="description2"><h2 class="dishNames2">'+dish.Title+'</h2> ';
				dishStr += '<h3 >'+dish.Description+'</h3></div>';
				dishStr += '<div class="description2"><h3 class="dishNames2">Preperation</h3><h3>'+dish.Instructions+'</h3></div></div>';
